...
ef=names(ef)
#save(samal,samin,ef,file='/Data/geod/dtb/ref/170428.geo.samples.ftp.Rdata')
#save(samal,samin,ef,file='/Data/geod/dtb/ref/170502.geo.samples.ftp.Rdata')
#save(samal,samin,ef,file='/Data/geod/dtb/ref/170524.geo.samples.ftp.Rdata')
# save(samal,samin,ef,file='/Data/geod/dtb/ref/170526.geo.samples.ftp.Rdata')
...
options(menu.graphics=FALSE);library(R.helper)#╣═╩╚╣║╔╔╣╦═║║╔╚║╔╚╔╣╩╚╚╦╣║╩╔╦║║ ╚╩╣╚╚╣║╣╚╩╔╦╩╚╦╚╩╣
#╚═╝╩═╩╝╚═╩══╩═╩═╩═╩╝╩═╩╝╚═╩═╩═╩╝╚═╝╩═╩╝╚═╩══╩═╩═╩═╩╝╩═╩╝╚═╩═╩═╩╝╚═╝╩═╩╝╚═╩══╩═╩═╩═╩╝╩═╩╝╚═╩═╩╩═╝
#Load('/Data/geod/dtb/ref/250417.geo.samples.ftp.ids__partial769missing.Rdata')
#Load('/Data/geod/dtb/ref/170428.geo.samples.ftp.Rdata')
k=1


#save(samal,file='/Data/geod/dtb/ref/250417.geo.samples.ftp.ids.Rdata')

#samal=samal[-1,]
#	str(samal)

##save(samal,file='/Data/geod/dtb/ref/200317.geo.samples.ftp.ids.Rdata')
##save(samal,file='/Data/geod/dtb/ref/050417.geo.samples.ftp.ids.Rdata')
##save(samal,file='/Data/geod/dtb/ref/210417.geo.samples.ftp.ids.Rdata')
#save(samal,file='/Data/geod/dtb/ref/250417.geo.samples.ftp.ids.Rdata')
...
#Load('/Data/geod/dtb/ref/geo.series.info.refined.proj.160317.Rdata')
